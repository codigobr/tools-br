    ...
    base.methods = {
      ...
      setup: function() {
        ...
        if ($(resultsScreen).length === 0) {
          quizHtml += '<div class="mv-20" id="' + resultsScreen.substr(1) + '">';
        ...
        quizHtml += '<a class="ui right labeled basic icon button" id="quiz-next-btn"><i class="right arrow icon"></i>' + nextButtonText + '</a>';
        quizHtml += '<a class="ui basic button" id="quiz-finish-btn">' + finishButtonText + '</a>';
        quizHtml += '<a class="ui basic button" id="quiz-restart-btn">' + restartButtonText + '</a>';
        quizHtml += '</div>';
        quizHtml += '</div>';
      ...
      gameOver: function(response) {
        ...
        if ($(gameOverScreen).length === 0) {
          ...
          quizHtml += '<p><a id="quiz-retry-btn">' + restartButtonText + '</a></p>';
          quizHtml += '</div>';
